--[[
Support conversation flow — dynamic arm: same BASE as static + ephemeral orchestrator suffix.

Run: tactus run support_flow_dynamic.tac
Mock: tactus test support_flow_dynamic.tac --mock --param skip_hitl=true
--]]
...
-- dynamic arm can provide deterministic, verifiable guidance.
